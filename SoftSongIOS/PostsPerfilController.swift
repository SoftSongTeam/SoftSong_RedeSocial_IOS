...
class PostsPerfilController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func DownloadJSON()
    {
        ...
        let x : String = self.id
        let url = NSURL(string: "http://\(ViewController.IP)/PostDealsMy.php?id=\(x)")
